document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadTasks() {
        const tasks = JSON.parse(localStorage.getItem('podcastTasks')) || [];
        tasks.forEach(task => {
    ...
    function saveTasks() {
        ...
        localStorage.setItem('podcastTasks', JSON.stringify(allTasks));
    }
    ...
    function loadTheme() {
        const theme = localStorage.getItem('podcastTheme');
        if (theme) {
            applyTheme(theme);
        }
    }
