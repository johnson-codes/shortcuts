document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadTasks() {
        const tasks = JSON.parse(localStorage.getItem('gcpShortcutsTasks')) || [];
        tasks.forEach(task => {
    ...
    function saveTasks() {
        ...
        localStorage.setItem('gcpShortcutsTasks', JSON.stringify(allTasks));
    }
    ...
    function addTaskToList(taskText, completed, listId) {
        ...
        // Make task text editable on double-click
