document.addEventListener('DOMContentLoaded', () => {
    ...
    const localStorageKey = 'uniqueDataTypeTasks';

    // Load tasks from localStorage
    function loadTasks() {
        const tasks = JSON.parse(localStorage.getItem('securityTasks')) || [];
        tasks.forEach(task => {
    ...
    function saveTasks() {
        ...
        localStorage.setItem('securityTasks', JSON.stringify(tasks)); // Updated key
    }
